...
function pass()
  ...
  gg.searchNumber("1.1F;1.4F:3::1", gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("1.1D;1.4D:2::10", gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
  gg.toast("Bypasa Succesfull")
  gg.alert("X Crazy")
end
function readthis()
  gg.setVisible(false)
  HH = gg.alert([[
Fungsi Bypass: Melindungi Crash / FC saat mengaktifkan script 
     Jika telat atau tidak menyalakan Bypass, PUBG kalian akan keluar setelah mencoba mengaktifkan sesuatu 
     Kalian perlu memulai bypass pada waktu yang tepat, yaitu pada layar awal logo Tencent & Lighspeed 
     Saat kalian membaca ini, kalian harus relog, karna telat membypass, silahkan keluar dari PUBG, lalu buka kembali]], "× BACK ×", "[ EXIT GAME ]")
  if HH == 1 then
    sbps()
  end
  if HH == 2 then
...
function fuckyou()
  gg.toast("DATA HAS BEEN CHANGES YOU HASBEN DISCONNET")
  gg.processKill()
  os.exit()
end
...
function HOME()
  MN = gg.choice({
    "📂 Wallhack+Color | Lobby 1x",
    "📂 Landing | In Game",
    "📂 Reduce Risk Ban | Fix",
    "📂 Simple Menu | Lobby/In Game",
    "📂 Credit",
    "========》[ EXIT ] 《========",
  }, nil, "🇽 🇨 🇷 🇦 🇿 🇾🇮🇩\nApk Playstore & Apk Korea    ")
 if MN == nil then
  else
  if MN == 1 then WHK()end
  if MN == 2 then MF2() end
  if MN == 3 then TST() end
  if MN == 4 then PPK() end
  if MN == 5 then ctn() end
  if MN == 6 then
     Exit()
     end
  end
...
function TST()
  GG6 = gg.multiChoice({
  	"🔹Reduce Risk Ban 1st After Open PUBG",
  	"🔹Antiban Virtual/Up Normal [In Game]",
      "🔹Antiban Virtual/Up Normal Final Match [In Game]",
      "🔹Block Notification And Freeze [In Game]",
      "🔹Reduce Risk Ban 20 Player [In Game]",
      "🔹Reduce Risk Ban 50 Player [In Game]",
      "🔹Reduce Risk Ban END Chicken",
      "======》 [ BACK ] 《======"
  }, nil, "??????????")
  if GG6 == nil then
  else
...
function TT1()
gg.alert("Hanya Untuk 1x Game , Setelah Itu Login Kembali")
gg.clearResults()
gg.setRanges(4)
...
gg.clearResults()
gg.setRanges(4)
gg.searchNumber("1,232,364,871;1,231,974,243", 4, false, 536870912, 0, -1)
gg.searchNumber("1,232,364,871;1,231,974,243", 4, false, 536870912, 0, -1)
...
gg.clearResults()
gg.setRanges(4)
gg.searchNumber("1,953,260,900;1,835,619,425", 4, false, 536870912, 0, -1)
gg.searchNumber("1,953,260,900;1,835,619,425", 4, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("0", 4)
gg.toast("X Crazy")
gg.clearResults()
gg.clearResults()
gg.searchNumber("909391408;808923191::8", 4, false, 536870912, 0, -1)
local t = gg.getResultCount()
gg.toast("Mohon Bersabar")
gg.clearResults()
gg.searchNumber("257D;0~99999F;1D;0D::300", 16, false, 536870912, 0, -1)
local t = gg.getResultCount()
gg.searchNumber("0~9999", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("0", 16)
gg.toast("Done")
gg.clearResults()
...
function PPK()
  KNP = gg.choice({
    "📂Headshot Menu | In Game",
    "📂Aim Menu | In Game",
    "📂Speed Menu | In Game 1x",
    "📂Brutal Mode | In Game 1x",
    "📂Recoil Menu | Lobby 1x",
    "📂Fix Wallhack Blink | In Game 1x",
    "📂Antiban Game | In Game 1x",
    "======》 [ BACK ] 《======"
 }, nil, "??????????")
 if KNP == nil then
  else
  if KNP == 1 then HKO() end
  if KNP == 2 then TAILU() end
  if KNP == 3 then SPH() end
  if KNP == 4 then BTRZUX() end
  if KNP == 5 then SVK() end
  if KNP == 6 then FBK() end
  if KNP == 7 then ANTK() end
  if KNP == 8 then
     HOME()
     end
  end
...
function HEADSHOOTMAGIC()
  ...
  gg.clearResults()
  gg.toast("Headshoot Magic Active!")
end
function HEADSHOOTONLY()
  gg.clearResults()
  gg.setRanges(32)
...
function TAILU()
  BRK = gg.multiChoice({
     ...
     "🔹Aimbot 200M [In Game]",
     "🔹Aimbot 50M [In Game]",
     "🔹Super Aimbot [In Game]",
     "🔹Medium Aimbot [In Game]",
     "🔹Awm Aimlock [In Game]",
     "🔹Aimbot Sniper [In Game]",
     "======》 [ BACK ] 《======"
 }, nil, "??????")
  if BRK == nil then
  else
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("30;30;0.3;0.3;80;25;220::", 16, false, 536870912, 0, -1)
gg.searchNumber("0.3", 16, false, 536870912, 0, -1)
local t = gg.getResults(10)
gg.editAll("0.03", 16)
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("36;1065353216;50528513;1203982336:", 4, false, 536870912, 0, -1)
gg.searchNumber("1065353216", 4, false, 536870912, 0, -1)
local t = gg.getResults(10)
gg.editAll("1,090,519,040", 4)
gg.clearResults()
...
function AMB()
  ...
  gg.clearResults()
  gg.alert("Aimbot 200Meter Sucses")
end
function AMY()
gg.clearResults()
  ...
  gg.clearResults()
  gg.alert("Aimbot 50Meter Sucses")
end
function ALK()
gg.clearResults()
gg.setRanges(16384)
...
function SPRM()
  ...
  gg.clearResults()
  gg.alert("Super Ultra AimBot activated!")
end
function AWMLCK()
  gg.clearResults()
...
function ANT()
  PP8 = gg.multiChoice({
    "🔹Reduce Risk Ban [Loading/After Logo]",
    "🔹Reduce Risk Ban V1 [Lobby]",
    "🔹Reduce Risk Ban V2 [Land]",
    "🔹Reduce Risk Ban V3 [Land]",
    "🔹Antiban 10 Min [Game]",
    "🔹Antiban 10 Min V2 [Game]",
    "======》 [ BACK ] 《======"
  }, nil, "?????")
  if PP8 == nil then
  else
...
function BAT1()
  ...
  gg.editAll("0", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert("Proses To Remove Repord")
...
function BTRZUX()
gg.alert("Make Sure You Use VPN")
  MN9 = gg.choice({
  	"🔹 Brutal With Sit Scope",
      "🔹 Brutal Without Sit Scope",
      "× BACK ×"
 }, nil, "???????")
  if MN9 == nil then
  else
...
--NOW : %Y/%m/%d Time: %H:%M:%S]]))
  ...
  gg.editAll("0", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.alert("Done Bangsat")
end
function WHK()
 RBH = gg.choice({
   "🔹Universal Wallhack Smoot Grapich",
   "🔹Wallhack 625 Smoot Grapich",
   "🔹Wallhack 625 HDR Grapich",
   "🔹Wallhack 845 HD Grapich",
   "🔹Wallhack 410 Smoot Grapich",
   "🔹Wallhack 425 Smoot Grapich",
   "🔹Wallhack 435 Smoot Grapich",
    "======》 [ BACK ] 《======"
 }, nil, "????????")
  if RBH == nil then
  else
...
gg.searchNumber("2", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("120", 16, false, 536870912, 0, -1)
gg.clearResults()
...
gg.editAll("120", 16, false, 536870912, 0, -1)
gg.clearResults()
gg.toast("Wallhack 410 Done")
end
function whun()
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("-8.3252823e-40;4.8330514509115e+21;3.7615819226313e-37;2::1250", 16, false, 536870912, 0, -1)
gg.searchNumber("-8.3252823e-40", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("-8.3852299e-40", 16)
gg.toast("loading")
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("-3.4039221e-39;4.814603017988e+21;2::1250", 16, false, 536870912, 0, -1)
gg.searchNumber("-3.4039221e-39", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("-3.4099169e-39", 16)
gg.toast("loading")
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("-1.0161992e-39;2::1250", 16, false, 536870912, 0, -1)
gg.searchNumber("-1.0161992e-39", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("-1.022194e-39", 16)
gg.toast("loading")
gg.setRanges(131072)
gg.searchNumber("-3.5875931e-39;4.8699618e21::40", 16, false, 536870912, 0, -1)
gg.searchNumber("-3.5875931e-39", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("-3.5935879e-39", 16)
gg.toast("loading")
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("4140D;4241", 2, false, 536870912, 0, -1)
gg.searchNumber("4140D;4241", 2, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("8482", 2)
gg.toast("Complete")
...
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("74B;104B;64B;1.1938615e-39F;-1.4693693e-39F::80", 2, false, 536870912, 0, -1)
gg.searchNumber("104", 1, false, 536870912, 0, -1)
gg.searchAddress("32E")
local t = gg.getResults(100)
gg.editAll("0", 1)
gg.toast("White")
end
...
gg.clearResults()
gg.setRanges(131072)
gg.searchNumber("1.1202011e-19F;1.1202015e-19F; 3.7615819e-37F;255.0F;2.0F:512", 16, false, 536870912, 0, -1)
gg.searchNumber("2", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("99999", 16)
gg.toast("Fix Old")
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("9.201618;30.5;25;0", 16, false, 536870912, 0, -1)
gg.searchNumber("25", 16, false, 536870912, 0, -1)
local t = gg.getResults(10)
gg.editAll("50", 16)
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("9.201618;30.5;180;0", 16, false, 536870912, 0, -1)
gg.searchNumber("30.5", 16, false, 536870912, 0, -1)
local t = gg.getResults(10)
gg.editAll("60", 16)
gg.clearResults()
gg.toast("Magic Bullet Mini activated!")
end
function SML()
gg.clearResults()
gg.setRanges(32)
...
gg.editAll("5", 4)
gg.clearResults()
gg.toast("Red Sky Done")
end
function NT()
gg.setRanges(32)
gg.searchNumber("68000", 16, false, 536870912, 0, -1)
gg.searchNumber("68000", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
...
function SPEED25()
  ...
  gg.clearResults()
  gg.toast("2,5 Speed Successful Activation")
end
function AHS()
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
gg.clearResults()
gg.toast("Less Recoil Lobby Succesfull")
end
function LRL()
gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function KCP()
gg.toast("Aimlock AWM is has been active")
gg.clearResults()
...
gg.clearResults()
gg.toast("No Recoil Lobby actived")
end
function HST()
gg.setRanges(32)
...
gg.searchNumber("18", 16, false, 536870912, 0, -1)
local t = gg.getResults(250)
gg.editAll("100", 16)
gg.clearResults()
gg.toast("Auto Hit Done")
end
function SX()
gg.setRanges(32)
gg.searchNumber("0.20000000298~0.30000001192F;53.0F;30.0F;1.0F::512", 16, false, 536870912, 0, -1)
gg.searchNumber("0.20000000298~0.30000001192F;1.0F::512", 16, false, 536870912, 0, -1)
local t = gg.getResults(200)
gg.editAll("1.4012985e-45", 16)
gg.clearResults()
gg.toast("Anti Shake Done")
end
function BTF()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  ...
  gg.clearResults()
  gg.toast("Magic Bullet Etreme Stable ON")
end
function MBS()
gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function KTG()
gg.alert("Use Anti Virtual In Game [ON] And Turn Of After Chicken 2x And Pres Back Button")
  KJ8 = gg.multiChoice({
  	"🔹Antiban 10Menit ON",
      "🔹Antiban 10Menit OF",
      "× BACK ×",
...
gg.alert("TURNED OFF, ACTIVATE AGAIN WHEN YOU PLAY")
end
function OTHR()
  KS9 = gg.multiChoice({
  	"🔹Sit Scope",
...
function MulJump()
  ...
  gg.getResults(9999)
  gg.editAll("999", gg.TYPE_FLOAT)
  gg.toast("Multi Jump Jump Active")
  gg.clearResults()
end
function SS()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
gg.clearResults()
gg.setRanges(16416)
gg.searchNumber("20000;750;0.0001;0.07 ", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("0", 16)
gg.clearResults()
gg.setRanges(16416)
gg.searchNumber("2.55F;0.6;0.1;0.125F::55", 16, false, 536870912, 0, -1)
local t = gg.getResults(100)
gg.editAll("1", 16)
gg.clearResults()
end
...
gg.clearResults()
  ...
  gg.editAll("9999", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Jump Wall activated!")
end
function PVP()
gg.alert("Headshot+ Aimlock + Bullet Tracking & Magic Bullet + Damage Plus + No Foot")
gg.setRanges(gg.REGION_BAD)
...
gg.clearResults()
gg.toast("TRACK BULLET")
end
function PVE()
gg.alert("Ultra Aimbot + Headshot 99% + Magic Bullet & Bullet Tracking + Damage Plus +No Foot")
...
function ctn()
  KONTAK = gg.choice({
    "🔭Telegram : @goodoflua",
    "🔭Youtube : AdityaGalang🇲🇨",
    "🏧Paypal : Adityagalang1945@gmail.com",
    "======》 [ BACK ] 《======"
  }, nil, "???????")
  if KONTAK == 1 then
    ctn()
...
function Exit()
  gg.toast("🔹X乛Team Online Loader🔹")
  print("🔹X乛Team ONLINE ")
  print("🔹Are You Ric?")
  print("🔹Donate Me Paypal:Adityagalang1945@gmail.com")
  print("🔹Thank For Support X乛Team")
  os.exit()
end
function sbps()
  gg.setVisible(false)
  HH = gg.alert("Bypass Dulu Citer Kampret", "YES", "NO", "Baca Dulu")
  if HH == 1 then
    pass()
  end
  if HH == 2 then
