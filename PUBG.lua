...
gg.alert("VIP Script PUBG MOBILE 0.11")
gg.alert("-------------------Welcome-------------------")
gg.alert("Try To Acces Menu")
gg.toast("Loading........10%")
gg.sleep(520)
gg.toast("Loading........20%")
gg.sleep(520)
...
function HOME()
 ...
 if MN == nil then
  ...
  if MN == 4 then OTHR() end
  if MN == 5 then KTG() end
  if MN == 6 then CLICK() end
  if MN == 7 then PPK() end
  if MN == 8 then HLP() end
  if MN == 9 then ctn() end
  if MN == 10 then
     Exit()
     end
  end
...
gg.alert("⛔ IDENTIFICATION Failed\n      your not a valid member, please registration first... \nContact admin in http://t.me/Goodoflua")
end
function PPK()
  KNP = gg.choice({
    "📂Headshot Menu",
...
function ANT()
  PP8 = gg.multiChoice({
    "☣️Reduce Risk Ban [Loading/After Logo]",
    "☣️Reduce Risk Ban V1 [Lobby]",
    "☣️Reduce Risk Ban V2 [Land]",
    "☣️Reduce Risk Ban V3 [Land]",
    "☣️Antiban 10 Min [Game]",
    "☣️Antiban 10 Min V2 [Game]",
    "Back"
  }, nil, "?????")
  if PP8 == nil then
  else
...
gg.alert("Make Sure You Use VPN")
  MN9 = gg.choice({
  	"☣️ Brutal With Sit Scope",
      "☣️ Brutal Without Sit Scope",
      "× BACK ×"
 }, nil, "???????")
  if MN9 == nil then
  else
...
function MF2()
  MN6 = gg.multiChoice({
    "▶️Less Recoil Lobby Fix",
    "▶️No Recoil Lobby",
    "▶️No Recoil Land",
    "▶️Less Recoil Land",
    "▶️Auto Headshot 95%",
    "▶️Magic Bullet",
    "▶️Magic Bullet Extreme Stable",
    "▶️Damage Plus",
    "▶️Soft Aimlock",
    "▶️Bullet Tracking",
    "▶️Bullet Tracking New",
    "▶️Sniper Aimlock",
    "▶️Headshot+Magic Bullet",
    "▶️Aim Head New",
    "▶️Auto Hit Enemy",
    "▶️Anti Shake",
    "▶️Instan GUN",
...
function CLICK()
  LOL = gg.choice({
    "☣️ Headshot+Aimlock",
    "☣️ Fix Wallhack+ Speed 2.5",
    "☣️ Damage Plus+Bullet Tracking New",
    "☣️ Chicken Dinner Pack 1",
    "☣️ Chicken Dinner Pack 2",
    "× BACK ×"
    }, nil, "??????")
  if LOL == nil then
  else
...
function Exit()
  ...
  gg.toast("KONTOL")
  print("-----------------------------------------------------------------")
  print("Aditya PUBG MOBILE 0.11")
  print("Want Private Trick Contac Me")
  print("Use Your Own Risk")
  print("-----------------------------------------------------------------")
  os.exit()
end
function sbps()
  gg.setVisible(false)
  HH = gg.alert("☠️BYPASS 0.11☠️", "🔺YES🔺", "🔺DONE🔺 ", "📌READ THIS")
  if HH == 1 then
    pass()
  end
  if HH == 2 then
